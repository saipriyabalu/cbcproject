...
}(window,document,"Bots", "http://150.136.216.174:8081/bots-client-sdk-js");
...
function saveAppId(e){
    ...
    let appId="5d9cf66b0b3be600105113b7";
...
function loadChat(e){
    ...
    //var appId = window.localStorage.getItem("appId");
    var appId="5d9cf66b0b3be600105113b7";
    initBots(appId)
        .then(function () {
...
function initBots(appId){
    return Bots.init({
        ...
        buttonHeight: '58px',
        businessName: "CIBC",
        businessIconUrl: 'https://upload.wikimedia.org/wikipedia/en/thumb/c/cf/CIBC_logo.svg/300px-CIBC_logo.svg.png',
        ...
        customText: {
            ...
            introductionText: 'A leading North American financial institution',
